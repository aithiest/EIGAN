...
def main(expt, model):
    pca_1 = pkl.load(open('checkpoints/titanic/ind_pca_training_history_01_15_2020_23_25_44.pkl', 'rb')) # 87.5, 76.39, 66.67
    pca_2 = pkl.load(open('checkpoints/titanic/ind_pca_training_history_01_15_2020_23_45_00.pkl', 'rb')) # 93.05, 79.17, 76.39
